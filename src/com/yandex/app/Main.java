...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("head: " + historyManager.getCustomLinkedList().getHead() + " tail: " + historyManager.getCustomLinkedList().getTail() + ", size: " + historyManager.getCustomLinkedList().getSize() + ", viewedTasks: " + historyManager.getViewedTasks());
        ...
        System.out.println("История просмотров: " + historyManager.getViewedTasks());
