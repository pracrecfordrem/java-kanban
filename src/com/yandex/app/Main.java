...
//        System.out.println("head: " + historyManager.customLinkedList.getHead() + " tail: " + historyManager.customLinkedList.getTail() + ", size: " + historyManager.customLinkedList.getSize() + ", viewedTasks: " + InMemoryHistoryManager.viewedTasks);
...
//
//
//        System.out.println("История просмотров: " + historyManager.viewedTasks);
